...
mod imp {
    ...
    #[template(resource = "/io/github/htkhiem/Euphonica/gtk/library/dynamic-playlist-song-row.ui")]
    pub struct DynamicPlaylistSongRow {
        #[template_child]
    ...
    impl ObjectSubclass for DynamicPlaylistSongRow {
        // `NAME` needs to match `class` attribute of template
        const NAME: &'static str = "EuphonicaDynamicPlaylistSongRow";
        type Type = super::DynamicPlaylistSongRow;
    ...
    impl ObjectImpl for DynamicPlaylistSongRow {
    ...
    impl WidgetImpl for DynamicPlaylistSongRow {}

    // Trait shared by all boxes
    impl BoxImpl for DynamicPlaylistSongRow {}
}

glib::wrapper! {
    pub struct DynamicPlaylistSongRow(ObjectSubclass<imp::DynamicPlaylistSongRow>)
    @extends gtk::Box, gtk::Widget,
    @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
}

impl DynamicPlaylistSongRow {
    ...
    pub fn setup(&self, library: Library, item: &gtk::ListItem, cache: Rc<Cache>) {
        ...
        self.imp()
           .cache
           .set(cache)
           .expect("DynamicPlaylistSongRow cannot bind to cache");
